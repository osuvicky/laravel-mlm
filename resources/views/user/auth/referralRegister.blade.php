...
<div class="row">
    ...
    <form method="POST" action="{{ route('registered') }}">
        ...
        <div class="form-group col-6">
            <x-input-label for="referral_code" value="Referral Code for {{$userData[0]['firstname']}} {{$userData[0]['lastname']}}" />
            <x-text-input id="referral_code" class="form-control" type="text" name="referral_code" value="{{$referral}}" autofocus autocomplete="referral_code" disabled/>
