                    ...
                    <div class="row ">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <img src="{{asset('')}}dashboard_assets/assets/img/banner/1.png" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <img src="{{asset('')}}dashboard_assets/assets/img/banner/2.png" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <img src="{{asset('')}}dashboard_assets/assets/img/banner/3.png" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <img src="{{asset('')}}dashboard_assets/assets/img/banner/4.png" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="card ">
                <div class="card-header">
                  ...
                  <div class="card-header-action">
                    <div class="dropdown">
                      <a href="#" data-bs-toggle="dropdown" class="btn btn-warning dropdown-toggle">Options</a>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="support-ticket media pb-1 mb-3 d-flex">
                    <img src="{{asset('')}}dashboard_assets/assets/img/users/user-1.png" class="user-img mr-2" alt="">
                    <div class="flex-1 ms-3">
                      ...
                      <small class="text-muted">Created by <span class="fw-bold font-13">John
                          Deo</span>
                        &nbsp;&nbsp; - 1 day ago</small>
                    </div>
                  </div>
                  <div class="support-ticket media pb-1 mb-3 d-flex">
                    <img src="{{asset('')}}dashboard_assets/assets/img/users/user-2.png" class="user-img mr-2" alt="">
                    <div class="flex-1 ms-3">
                      <div class="badge badge-pill btn-warning mb-1 float-right">Bug</div>
                      ...
                      <small class="text-muted">Created by <span class="fw-bold font-13">Sarah
                          Smith</span>
                        &nbsp;&nbsp; - 2 day ago</small>
                    </div>
                  </div>
                  <div class="support-ticket media pb-1 mb-3 d-flex">
                    <img src="{{asset('')}}dashboard_assets/assets/img/users/user-3.png" class="user-img mr-2" alt="">
                    <div class="flex-1 ms-3">
                      ...
                      <small class="text-muted">Created by <span class="fw-bold font-13">Ashton Cox</span>
                        &nbsp;&nbsp; -2 day ago</small>
                    </div>
                  </div>
                  <div class="support-ticket media pb-1 mb-3 d-flex">
                    <img src="{{asset('')}}dashboard_assets/assets/img/users/user-6.png" class="user-img mr-2" alt="">
                    <div class="flex-1 ms-3">
                      ...
                      <small class="text-muted">Created by <span class="fw-bold font-13">Hasan
                          Basri</span>
                        &nbsp;&nbsp; -3 day ago</small>
                    </div>
                  </div>
