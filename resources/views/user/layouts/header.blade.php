      ...
      <nav class="navbar navbar-expand-lg main-navbar sticky">
        ...
        <ul class="navbar-nav navbar-right">
            ...
            <div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
              ...
              <div class="dropdown-list-content dropdown-list-message">
                <a href="#" class="dropdown-item"> <span class="dropdown-item-avatar
											text-white"> <img alt="image" src="{{asset('')}}dashboard_assets/assets/img/users/user1.png" class="rounded-circle">
                    ...
                    <img alt="image" src="{{asset('')}}dashboard_assets/assets/img/users/user-2.png" class="rounded-circle">
                    ...
                    <img alt="image" src="{{asset('')}}dashboard_assets/assets/img/users/user-5.png" class="rounded-circle">
                  </span> <span class="dropdown-item-desc"> <span class="message-user">Jacob
                      Ryan</span> <span class="time messege-text">Your payment invoice is
                      generated.</span> <span class="time">12 Min Ago</span>
                  </span>
                </a> <a href="#" class="dropdown-item"> <span class="dropdown-item-avatar text-white">
                    <img alt="image" src="{{asset('')}}dashboard_assets/assets/img/users/user-4.png" class="rounded-circle">
                    ...
                    <img alt="image" src="{{asset('')}}dashboard_assets/assets/img/users/user-3.png" class="rounded-circle">
          ...
          <li class="dropdown"><a href="#" data-bs-toggle="dropdown"
              class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image" src="{{asset('')}}dashboard_assets/assets/img/users/user1.png"
            ...
            <div class="dropdown-menu dropdown-menu-right pullDown">
              ...
              <form method="POST" action="{{ route('logout') }}" style="margin:20px 0 0 0px; width: auto;">
                    @csrf
