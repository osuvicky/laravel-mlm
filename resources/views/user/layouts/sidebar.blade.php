<div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="{{url('/')}}"> <img alt="image" src="{{asset('')}}dashboard_assets/assets/img/logo.png" class="header-logo" /> <span
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              <a href="{{route('dashboard')}}" class="nav-link"><i data-feather="globe"></i><span>Dashboard</span></a>
            </li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="briefcase"></i><span>Plans</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{route('plans')}}">Subscribe</a></li>
                <li><a class="nav-link" href="{{route('plans')}}">Upgrade</a></li>
                <li><a class="nav-link" href="{{route('plans')}}">Renew</a></li>
              </ul>
            </li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="mail"></i><span>Referrals</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{route('user.directgroup')}}">Direct Referrals</a></li>
                <li><a class="nav-link" href="{{route('user.levelgroup')}}">Referral Matrix</a></li>
                <li><a class="nav-link" href="{{route('user.tree')}}">Referral Tree</a></li>
              </ul>
            </li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="command"></i><span>Transactions</span></a>
              <ul class="dropdown-menu">
              <li><a class="nav-link" href="{{route('deposit')}}">Deposit</a></li>
              <li><a class="nav-link" href="{{route('plans')}}">Withdraw</a></li>
              </ul>
            </li>
