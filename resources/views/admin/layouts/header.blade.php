      ...
      <nav class="navbar navbar-expand-lg main-navbar sticky">
        ...
        <ul class="navbar-nav navbar-right">
            ...
            <div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
              ...
              <div class="dropdown-list-content dropdown-list-message">
                <a href="#" class="dropdown-item"> <span class="dropdown-item-avatar
											text-white"> <img alt="image" src="{{asset('')}}dashboard_assets/assets/img/users/user-1.png" class="rounded-circle">
          ...
          <li class="dropdown"><a href="#" data-bs-toggle="dropdown"
              class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image" src="{{asset('')}}dashboard_assets/assets/img/user.png"
            ...
            <div class="dropdown-menu dropdown-menu-right pullDown">
              ...
              <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button class="dropdown-item has-icon text-danger"><span> <i class="fas fa-sign-out-alt"></i>Logout</span></button>
              </form>
            </div>
          </li>
        </ul>
