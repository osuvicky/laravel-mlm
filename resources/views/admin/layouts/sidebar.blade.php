        ...
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="{{url('/')}}"> <img alt="image" src="{{asset('')}}dashboard_assets/assets/img/logo.png" class="header-logo" /> <span
                class="logo-name">{{ config('app.name', 'Laravel') }}</span>
            </a>
          </div>
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
              <a href="{{route('admin.index')}}" class="nav-link"><i data-feather="monitor"></i><span>Admin Dashboard</span></a>
            </li>
            @endrole
            <li class="dropdown">
              <a href="{{route('portal')}}" class="nav-link"><i data-feather="globe"></i><span>Dashboard</span></a>
            </li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="briefcase"></i><span>Roles</span></a>
            ...
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="command"></i><span>Plans</span></a>
              <ul class="dropdown-menu">
              <li><a class="nav-link" href="{{ route('admin.plans.index')}}">Plans</a></li>
              <li><a class="nav-link" href="{{ route('admin.plans.create')}}">Add Plan</a></li>
              </ul>
            </li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="mail"></i><span>App</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="">One</a></li>
                <li><a class="nav-link" href="">Two</a></li>
              </ul>
            </li>
